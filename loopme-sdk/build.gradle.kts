...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "IAS_LOOPME_PARTNER_ID", project.findProperty("IAS_LOOPME_PARTNER_ID") as? String ?: "")
        buildConfigField("String", "IAS_CM_TAG_URL", project.findProperty("IAS_CM_TAG_URL") as? String ?: "")
...
dependencies {
    ...
    implementation(files("libs/libAvid-loopme-3.6.7.jar"))
